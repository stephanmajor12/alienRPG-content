...
ix.config.Add("startingSkillPoints", 22, "The starting amount of attribute points a character has on creation.", nil, {
	data = { min = 0, max = 100 },
	category = "characters"
})

ix.config.Add("startingTraits", 1, "The starting amount of attribute points a character has on creation.", nil, {
	data = { min = 0, max = 10 },
	category = "characters"
})
